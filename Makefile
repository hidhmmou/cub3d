...
PARSING		=	check_map.c get_next_line.c utils_00.c utils_01.c\
				...
				get_map.c
RAY			=	tools.c press.c moves.c render.c render3d.c inter.c moves3d.c keys.c minimap.c bigmap.c helpminimap.c helpmoves.c init.c my_mlx_pixel.c init2.c keys2.c
